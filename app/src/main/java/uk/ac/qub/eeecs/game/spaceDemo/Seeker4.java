 ...
 * @version 1.0
 */
public class Seeker4 extends SpaceEntity {
     ...
     */
    public Seeker4(float startX, float startY, SpaceshipDemoScreen gameScreen) {
        ...
        mBitmap = gameScreen.getGame().getAssetManager().getBitmap("Spaceship5");
