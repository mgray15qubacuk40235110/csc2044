 ...
 * @version 1.0
 */
public class FleeShip extends SpaceEntity {
     ...
     */
    public FleeShip(float startX, float startY, SpaceshipDemoScreen gameScreen) {
        ...
        mBitmap = gameScreen.getGame().getAssetManager().getBitmap("Spaceship6");
